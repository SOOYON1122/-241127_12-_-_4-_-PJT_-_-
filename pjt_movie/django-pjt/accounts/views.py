...
def mypage_recom(request):
    ...
    if request.method == 'GET':
        ...
        return Response({'genre_recommendations':serializer_genre.data, 'review_recommendations':serializer_rating.data, 'bookmark_reccomendations': serializer_bookmark.data})
